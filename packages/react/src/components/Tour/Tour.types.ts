...
export interface TourProps {
   ...
   *
   * Open it *after* mount. Refs attach on commit, so opening on an anchored step
   * during the first render measures a null target: the spotlight collapses and
   * the card is parked off-screen. Opening from a click is always safe.
   */
  stepId: string | null;
  /**
