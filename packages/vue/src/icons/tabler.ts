 ...
 * Tabler icon adapter.
 *
 * Maps each canonical design system icon name to its `@tabler/icons-vue`
...
export const tablerIconSet: Record<CanonicalIconName, IconComponent> = {
 ...
 */
export const tablerSolidSet: Partial<Record<CanonicalIconName, IconComponent>> = {
