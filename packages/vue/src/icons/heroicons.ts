 ...
 * Heroicons adapter.
 *
 * Maps each canonical design system icon name to its `@heroicons/vue` component
 * for both outline and solid styles. Named imports keep tree-shaking intact.
 */
...
export const heroiconsOutlineSet: Record<CanonicalIconName, IconComponent> = {
...
export const heroiconsSolidSet: Record<CanonicalIconName, IconComponent> = {
