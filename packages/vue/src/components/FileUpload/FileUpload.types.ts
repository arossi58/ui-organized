...
export interface FileUploadProps {
  ...
  minFileSize?: number;
  /**
   * Controlled list of accepted files. Use `v-model:accepted-files` for
   * two-way binding — Ark Vue names this one `acceptedFiles` rather than
   * `modelValue`, and this package follows Ark.
   */
  acceptedFiles?: File[];
