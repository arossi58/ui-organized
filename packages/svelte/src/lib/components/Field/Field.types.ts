...
import type {
  HTMLAttributes, HTMLInputAttributes, HTMLLabelAttributes,
...
export interface FieldLabelProps
  extends ArkForwardable<Omit<HTMLLabelAttributes, "class">>, PartProps {}
export interface FieldDescriptionProps
  extends ArkForwardable<Omit<HTMLAttributes<HTMLSpanElement>, "class">>, PartProps {}
export interface FieldControlProps
  extends ArkForwardable<Omit<HTMLInputAttributes, "class">>, PartProps {
...
export interface FieldsetProps
  extends ArkForwardable<Omit<HTMLAttributes<HTMLFieldSetElement>, "class">>, PartProps {}
export interface FieldsetLegendProps
  extends ArkForwardable<Omit<HTMLAttributes<HTMLLegendElement>, "class">>, PartProps {}
