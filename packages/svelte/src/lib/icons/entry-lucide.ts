/**
 * `@ui-organized/svelte/icons/lucide` — the Lucide adapter.
 *
 ...
 * imports `@lucide/svelte`; nothing here is reachable from the main entry, which
 * is what keeps the other icon libraries out of your bundle.
 *
 * ```ts
 * import "@ui-organized/svelte/icons/lucide";   // register, then use library="lucide"
 * ```
 *
