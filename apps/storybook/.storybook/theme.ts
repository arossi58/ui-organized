...
export function makeManagerTheme(mode: ThemeMode, brand: string) {
  ...
  const ink = v("--color-content-primary", mode === "dark" ? "#f7f7f7" : "#17150f");
  ...
  return create({
    ...
    textColor: ink,
    textInverseColor: v("--color-content-inverse", "#ffffff"),
    textMutedColor: v("--color-content-secondary", "#6b6b6b"),

    barTextColor: v("--color-content-secondary", "#6b6b6b"),
