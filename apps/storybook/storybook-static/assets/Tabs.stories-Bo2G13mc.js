...
/>
`.trim()}}},render:l(()=>e.jsx(c,{tabs:[{value:"profile",label:"Profile",content:e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:e.jsx("p",{style:{margin:0,color:"var(--color-text-secondary)"},children:"Manage your personal information and account settings."})})},{value:"notifications",label:"Notifications",content:e.jsx("p",{style:{margin:0,color:"var(--color-text-secondary)"},children:"Configure how and when you receive notifications."})},{value:"security",label:"Security",content:e.jsx("p",{style:{margin:0,color:"var(--color-text-secondary)"},children:"Manage your password, two-factor authentication, and sessions."})}],defaultValue:"profile"}),"render")};var u,d,p;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
...
}`,...(h=(S=r.parameters)==null?void 0:S.docs)==null?void 0:h.source}}};var A,B,T;s.parameters={...s.parameters,docs:{...(A=s.parameters)==null?void 0:A.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
...
}`,...(T=(B=s.parameters)==null?void 0:B.docs)==null?void 0:T.source}}};var x,V,C;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
