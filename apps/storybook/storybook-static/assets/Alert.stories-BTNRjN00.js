...
`.trim()}}},render:s(()=>{const[i,a]=W.useState(!0);return i?e.jsx("div",{style:{maxWidth:"520px"},children:e.jsx(t,{variant:"info",title:"Dismissible alert",onDismiss:s(()=>a(!1),"onDismiss"),children:"Click the dismiss button to hide this alert."})}):e.jsx("p",{style:{color:"var(--color-text-text-tertiary)"},children:"Alert was dismissed."})},"render")},d={parameters:{docs:{source:{code:`
...
`.trim()}}},render:s(()=>{const[i,a]=W.useState({}),u=["info","success","warning","error"];return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px",maxWidth:"520px"},children:[u.filter(r=>!i[r]).map(r=>e.jsxs(t,{variant:r,title:`${r.charAt(0).toUpperCase()+r.slice(1)} alert`,onDismiss:s(()=>a(Y=>({...Y,[r]:!0})),"onDismiss"),children:["This is a dismissible ",r," alert."]},r)),u.every(r=>i[r])&&e.jsx("p",{style:{color:"var(--color-text-text-tertiary)"},children:"All alerts dismissed."})]})},"render")};var m,p,v;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    variant: "info",
    title: "Heads up",
