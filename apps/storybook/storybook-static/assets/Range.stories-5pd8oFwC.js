import{h as a,j as e,r as F}from"./iframe-mpPisOQX.js";import"./preload-helper-C1FmrZbK.js";const P={title:"Components/Range",component:a,parameters:{layout:"padded"},argTypes:{size:{control:"select",options:["sm","md","lg"]},label:{control:"text"},min:{control:"number"},max:{control:"number"},step:{control:"number"},rangeLabels:{control:"boolean"},hideValue:{control:"boolean"},disabled:{control:"boolean"},error:{control:"text"}}},p={display:"flex",flexDirection:"column",gap:"24px",maxWidth:"320px"},t={args:{label:"Volume",defaultValue:40,size:"md"}},o={args:{label:"Brightness",defaultValue:60,rangeLabels:!0}},u={render:()=>e.jsxs("div",{style:p,children:[e.jsx(a,{size:"sm",label:"Small",defaultValue:30,rangeLabels:!0}),e.jsx(a,{size:"md",label:"Medium",defaultValue:50,rangeLabels:!0}),e.jsx(a,{size:"lg",label:"Large",defaultValue:70,rangeLabels:!0})]})},d={render:()=>e.jsxs("div",{style:p,children:[e.jsx(a,{label:"Default",defaultValue:50,rangeLabels:!0}),e.jsx(a,{label:"Disabled",defaultValue:50,rangeLabels:!0,disabled:!0}),e.jsx(a,{label:"Error",defaultValue:50,rangeLabels:!0,error:"Please pick a lower value."})]})},s={args:{label:"Rating (steps of 10)",min:0,max:100,step:10,defaultValue:30,rangeLabels:!0}},l={render:()=>{const c=[8,16,24,32,48,64];return e.jsx("div",{style:p,children:e.jsx(a,{label:"Font size",snapValues:c,defaultValue:16,rangeLabels:!0,startLabel:"8px",endLabel:"64px",formatValue:n=>`${n}px`})})}},i={render:()=>{const[c,n]=F.useState(25);return e.jsxs("div",{style:p,children:[e.jsx(a,{label:"Opacity",value:c,onValueChange:n,rangeLabels:!0,formatValue:r=>`${r}%`}),e.jsx("div",{style:{display:"flex",gap:"8px"},children:[0,25,50,75,100].map(r=>e.jsxs("button",{type:"button",onClick:()=>n(r),children:[r,"%"]},r))})]})}};var m,b,g;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    label: "Volume",
    defaultValue: 40,
    size: "md"
