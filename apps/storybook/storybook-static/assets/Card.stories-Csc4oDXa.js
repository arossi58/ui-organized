...
`.trim()}}},render:e(a=>n.jsxs(d,{...a,style:{maxWidth:"380px"},children:[n.jsx(p,{children:n.jsx("strong",{children:"Card title"})}),n.jsx(i,{children:n.jsx("p",{style:{margin:0,color:"var(--color-text-secondary)",fontSize:"var(--type-size-body-medium)"},children:"This is the card body content. It can contain any content you need."})}),n.jsx(z,{children:n.jsx(l,{size:"sm",children:"Action"})})]}),"render"),args:{variant:"default",padding:"md"}},t={parameters:{docs:{source:{code:`
...
}`,...(u=(g=t.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var v,x,B;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
...
}`,...(B=(x=o.parameters)==null?void 0:x.docs)==null?void 0:B.source}}};var h,f,j;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
