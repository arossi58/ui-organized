import{F as j,j as o,I as D}from"./iframe-mpPisOQX.js";import"./preload-helper-C1FmrZbK.js";const L={title:"Components/FieldError",component:j,parameters:{layout:"padded"},argTypes:{children:{control:"text"}}},e={args:{children:"Error message"}},r={args:{children:""}},a={args:{children:"Please enter a valid email address before continuing."}},s={render:()=>o.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px",maxWidth:"320px"},children:o.jsx(D,{label:"Email",placeholder:"you@example.com",defaultValue:"not-an-email",error:"Enter a valid email address."})})};var n,t,i,d,c;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
