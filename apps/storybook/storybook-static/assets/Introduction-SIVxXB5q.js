var o=Object.defineProperty;var i=(s,n)=>o(s,"name",{value:n,configurable:!0});import{u as t,j as e,M as a}from"./iframe-BdMZ4otN.js";import"./preload-helper-BCNDPehi.js";const c="https://www.npmjs.com/package/@ui-organized/react",d="https://www.figma.com/community",l="https://github.com/arossi58/ui-organized";function r(s){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(a,{title:"Introduction"}),`
...
`,e.jsx("a",{href:c,target:"_blank",rel:"noreferrer",children:"npm — @ui-organized packages"}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx("a",{href:d,target:"_blank",rel:"noreferrer",children:"Figma — design library"})," ",e.jsx(n.em,{children:"(placeholder — drop in the published URL)"})]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx("a",{href:l,target:"_blank",rel:"noreferrer",children:"GitHub — source & docs"}),`
`]}),`
`]}),`
`,e.jsxs(n.p,{children:["Browse ",e.jsx(n.strong,{children:"Foundations"})," for the token reference, or ",e.jsx(n.strong,{children:"Components"})," for the library."]})]})}i(r,"_createMdxContent");function m(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}i(m,"MDXContent");export{d as FIGMA,l as GITHUB,c as NPM,m as default};
