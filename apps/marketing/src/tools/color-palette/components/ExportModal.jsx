      ...
      >
        <div style={{ padding: 24, flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <h2 style={{ margin: 0, fontSize: 24, fontWeight: 700, color: 'var(--color-content-primary)' }}>Export Palette</h2>
            <button
          ...
          <p style={{ margin: 0, marginTop: 8, fontSize: 14, color: 'var(--color-content-tertiary)' }}>
        ...
        <div style={{ padding: 24, flex: 1, overflowY: 'auto' }}>
          ...
          <div style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
              <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-content-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Include Colors</span>
              <button
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: isSelected ? 'var(--color-content-primary)' : 'var(--color-content-placeholder)',
                    }}
                  >
                    <div
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
            {CODE_FORMATS.map(fmt => (
              ...
              >
                ...
                />
                <div>
                  <div style={{ fontWeight: 600, color: 'var(--color-content-primary)' }}>{fmt.title}</div>
                  <div style={{ fontSize: 14, color: 'var(--color-content-tertiary)' }}>{fmt.desc}</div>
                </div>
              </label>
            ))}
          </div>
          ...
          <div style={{ background: 'var(--color-surface-secondary)', borderRadius: 8, padding: 16 }}>
            <pre style={{ margin: 0, fontSize: 12, color: 'var(--color-content-primary)', fontFamily: 'monospace', overflowX: 'auto', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>{generateExport(exportFormat, filteredColors, palettes, numStops, namingSystem, customIncrement)}</pre>
          </div>
        </div>
